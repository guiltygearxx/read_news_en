...
@Component({
    selector: 'app-m-news-card-4',
    templateUrl: './m-news-card-4.component.html',
    styleUrls: ['./m-news-card-4.component.css'],
    animations: [newsCardAppearAnimation]
})
export class MNewsCard4Component implements OnInit, AfterContentInit, SupportNewsCardAppearAnimation, NewsCardCommon {
